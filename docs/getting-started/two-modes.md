...
- [快速上手](quick-start.md) — 自动模式完整示例
- [核心概念](core-concept.md) — Schema → Field → Component 解析链
- [Angular API 参考](../api/angular.md) — `PiyingView` / `PiyingFieldControlBindDirective` / `PiyingFieldTemplateDirective` / `convertToField`
- [Control API](../api/control-api.md) — `field.form.control` 控件操作
