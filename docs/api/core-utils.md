# 核心工具函数（@piying/view-angular-core/util）
...
- [核心概念](../getting-started/core-concept.md) — Schema → Field → Component 解析链
- [Control API](control-api.md) — 表单控件值/状态/验证 API
- [FieldFormConfig](field-config.md) — 字段表单配置
