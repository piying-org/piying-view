...
<SchemaPreview definition="src/angular/definition/complete-example.definition.ts">
  <SchemaDemoComponent slot="preview" client:only="angular" name="complete-example" showModel />
</SchemaPreview>
