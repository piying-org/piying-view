...
import { QuickStartDemoComponent } from '../../../components/quick-start-demo.component.ts';
...
<LivePreview path="src/components/quick-start-demo.component.ts">
...
<SchemaPreview definition="src/components/definition/quick-start-schema.definition.ts">
