...
import { CompleteExampleDemoComponent } from '../../../components/complete-example-demo.component.ts';

本文通过一个注册表单的综合示例，整合前面所学的所有知识点。

<LivePreview path="src/components/complete-example-demo.component.ts">
