...
import { AsControlGroupDemoComponent } from '../../../components/as-control-group-demo.component.ts';
...
<LivePreview path="src/components/as-control-group-demo.component.ts">
...
<SchemaPreview definition="src/components/definition/control-group-default.definition.ts">
...
<SchemaPreview definition="src/components/definition/control-group-as-control.definition.ts">
...
<SchemaPreview definition="src/components/definition/control-group-as-virtual.definition.ts">
...
<SchemaPreview definition="src/components/definition/tabs-group.definition.ts">
...
<SchemaPreview definition="src/components/definition/layout.definition.ts">
