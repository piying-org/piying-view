...
| [字段指令配置](zh/angular/field-directives/) | 通过 `actions.directives` 附加自定义指令的行为（实例稳定、动态增删） |
...
- [快速上手](zh/getting-started/quick-start/) — BaseControl 控件编写
- [Wrappers 包装器](zh/api/wrappers/) — InsertFieldDirective 用法
- [框架差异](zh/getting-started/framework-differences/) — 各框架 Field Token 对比
