...
- [API: global-config](zh/api/global-config/) — fieldGlobalConfig 全局配置优先级体系
- [场景: 值转换与联动](zh/scenarios/value-transform/) — transformer / pipe 实战
- [场景: 数组高级用法](zh/scenarios/array-advanced/) — deletionMode / groupMode 实战
