...
KeyPath 类型定义、`field.get()` 用法 计算规则等基础知识详见 [路径查询 API](zh/api/path-querying/)。

## 下一步

- [API: hideWhen/disableWhen](zh/api/hide-disable/) — 动态控制可见性/可用性
- [API: fieldGlobalConfig](zh/api/global-config/) — 全局配置优先级
