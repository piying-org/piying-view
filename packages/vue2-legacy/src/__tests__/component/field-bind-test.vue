...
import { Field } from '@piying/view-vue2-legacy';
...
// 模板表达式不支持 TS, 事件处理放到 script 里
function onInput<V>(cvaa: { valueChange: (v: V) => void }, e: Event) {
  cvaa.valueChange((e.target as HTMLInputElement).value as V);
}
</script>
