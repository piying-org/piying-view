...
import { PiyingGroup, PiyingView, type PiViewConfig } from '@piying/view-react';
...
function TestComp(props: any) {
  ...
  return <PiyingView schema={schema} options={options} model={model} modelChange={props.modelChange}></PiyingView>;
}
